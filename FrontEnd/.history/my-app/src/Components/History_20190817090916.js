...
(this.props.onAddUpvote(this.props.blogs))}}/>
    ...
    <Downvote size ="20"style={{color:"#CEE3F8" ,marginTop:"6px",marginLeft:"6px"}}  onClick={(event)=>{
     ...
     (this.props.onDownVote(this.props.blogs))}}/>
      ...
      <Card.Title><Link to={`profiles/${this.props.blogs.PostId}`}><h5 style={{color:"black",marginLeft:"30px",marginBottom:"-3px",marginTop:"3px",fontFamily:"Verdana",letterSpacing:"-1px"} }>{this.props.blogs.Title}</h5></Link></Card.Title>
