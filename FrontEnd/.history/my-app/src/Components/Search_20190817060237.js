...
this.setState({userinfo:[]})
  ...
  return (
    ...
    {this.state.userinfo.map((info,index)=> <li style={{marginLeft:"60px",marginTop: "-1px",listStyle:"none",padding: "12px",display: "block",borderColor:"none"}}><UserDesign info={info}/></li>)}
    </ul>
