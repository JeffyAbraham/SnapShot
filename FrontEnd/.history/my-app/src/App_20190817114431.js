...
class App extends React.Component {
  ...
  {
    console.log("++++++++")
    axios.get("http://localhost:3001/post").then(res=>console.log(res.data.posts))
    axios.get("https://3em19ts012.execute-api.us-east-2.amazonaws.com/Dev/showdoctors").then(res=>this.setState({BlogInfo:res.data}))
  }
  constructor(props) {
