...
componentDidMount()
      {
        axios.get("https://3em19ts012.execute-api.us-east-2.amazonaws.com/Dev/showdoctors/"+this.props.match.params.id).then(res=>this.setState({commentInfo:res.data}))
        axios.post("https://3em19ts012.execute-api.us-east-2.amazonaws.com/Dev/singlepost",{"PostId":this.props.match.params.id}).then(res=>this.setState({GetSinglePost:res.data[0]}))
      }
handleCommentchange=(event)=>
    ...
    handleSubmit=(event)=>
    {
      ...
      console.log(token)
      axios.post("https://3em19ts012.execute-api.us-east-2.amazonaws.com/Dev/comment"+this.props.match.params.id,
    ...
    addUpvoteComment = (comm) => {
      ...
      axios.post(" https://3em19ts012.execute-api.us-east-2.amazonaws.com/Dev/votecomments/upvotecommnt",{CommentId:comm.CommentId}).then
      (function(response){
     ...
     { 
       if (this.state.commentInfo[i].CommentId===comm.CommentId)
       {
        ...
        newCommentInfo[i].Upvotes = parseInt(newCommentInfo[i].Upvotes)+1
  ...
  render(){
    ...
    console.log(this.state.GetSinglePost)
