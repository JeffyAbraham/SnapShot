...
class Post extends React.Component {
  ...
  handleSubmit=(event)=>{
    ...
    let config = {
      headers: {
        "Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFicmFoYW1famVmZnlAeWFob28uY29tIiwidXNlcklkIjoiNWQ1NmM2YTliY2RlMDgzZDEwZWRkMDZmIiwiaWF0IjoxNTY2MDc3NzU4LCJleHAiOjE1NjYwNzgwNTh9.BUeK7bzSonIM16hS7suCh3PssU-F_mMgIo-DG1gDxIA"
      }
    }
