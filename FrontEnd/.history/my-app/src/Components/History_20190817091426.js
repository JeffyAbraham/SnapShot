...
class History extends React.Component {
  ...
  <Card.Body>
    ...
    <Downvote size ="20"style={{color:"#CEE3F8" ,marginTop:"6px",marginLeft:"6px"}} />
      ...
      <Card.Title>><h5 style={{color:"black",marginLeft:"30px",marginBottom:"-3px",marginTop:"3px",fontFamily:"Verdana",letterSpacing:"-1px"} }>why so much pain</h5></Card.Title>
    ...
    <Card.Body>
     ...
     <div className="ol" style={{marginLeft:"30px"}}><Card.Text style={{fontFamily:"Verdana",fontWeight:"530"}} >
      Hey would you like to have tea
