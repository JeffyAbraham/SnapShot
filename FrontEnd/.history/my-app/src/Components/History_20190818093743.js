...
class History extends React.Component {
    componentDidMount()
    {
      ...
      axios.get("http://localhost:3001/post/"+this.props.match.params.id).then(res=>this.setState({post:res
  ...
  <Card.Body>
    ...
    {this.state.post.map((posts,index)=><History key={index} posts={posts}/> )}
