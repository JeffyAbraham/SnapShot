...
class Post extends React.Component {
  ...
  handleSubmit=(event)=>{
    ...
    let config = {
      headers: {
        "Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFicmFoYW1famVmZnlAeWFob28uY29tIiwidXNlcklkIjoiNWQ1NmM2YTliY2RlMDgzZDEwZWRkMDZmIiwiaWF0IjoxNTY2MDY5NjEzLCJleHAiOjE1NjYwNjk5MTN9.Xi67L5KlH0zVNuhKZVDdv6_ny2e5K1ijKkO1BZ3Gg9I"
      }
    }

    axios.post("http://localhost:3001/Post/5d56c6a9bcde083d10edd06",{
