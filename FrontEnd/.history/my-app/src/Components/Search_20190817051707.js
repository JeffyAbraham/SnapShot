...
this.setState({userinfo:[]})
  ...
  return (
    ...
    {this.state.userinfo.map((info,index)=> <li style={{marginLeft:"60px",border: "0.5px solid",marginTop: "-1px",listStyle:"none", backgroundColor:"#f6f6f6",padding: "12px",display: "block",borderColor:"#D3D3D3"}}>{info.username}</li>)}
    </ul>
