...
class Post extends React.Component {
 ...
 console.log(this.state)
  ...
  handleSubmit=(event)=>{
    ...
    bodyFormData.set("ImageLink",this.state.ImageLink)
    bodyFormData.append('selectedfile',this.state.selectedfile,this.state.selectedfile.name)
    


    axios.post("http://localhost:3001/Post/"+tokens.userId,bodyFormData,config).then(response=>{
...
render() { 
  ...
  return (
    <div>
      <img src="https://photovaultme.s3.amazonaws.com/Images/7c009319c39ddfe7dd0e024596b177f0.jpg"/>
