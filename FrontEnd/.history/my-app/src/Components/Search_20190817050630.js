...
this.setState({userinfo:[]})
  ...
  return (
    ...
    {this.state.userinfo.map((info,index)=> <li style={{marginLeft:"60px",border: "1px solid",marginTop: "-1px",listStyle:"none", backgroundColor:"#f6f6f6",padding: "12px"}}>{info.username}</li>)}
    </ul>
