...
class Historypost extends React.Component {
  ...
  return (
    ...
    <Downvote size ="20"style={{color:"#CEE3F8" ,marginTop:"6px",marginLeft:"6px"}} />
      ...
      <Card.Title><h6 style={{color:"black",marginLeft:"30px",marginBottom:"-3px",marginTop:"3px",fontFamily:"Verdana",letterSpacing:"-1px"} }>{this.props.posts.Title}</h6></Card.Title>
