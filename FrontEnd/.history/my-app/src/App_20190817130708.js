...
class App extends React.Component {
  ...
  addPost = (post) => {
    ...
    addDownvote = (blogs) => {
      ...
      axios.post("https://3em19ts012.execute-api.us-east-2.amazonaws.com/Dev/downVotes",{PostId:blogs.PostId}).then
      (function(response){
    ...
    addUpvote = (blogs) => {
      ...
      axios.post("https://3em19ts012.execute-api.us-east-2.amazonaws.com/Dev/upvotes",{PostId:blogs.PostId}).then
      (function(response){
        console.log("RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRe")
        console.log(blogs)
  ...
  return (
    ...
    <Route exact path="/Home" component={()=><Home BlogInfo={this.state.BlogInfo} onAddUpvote={this.addUpvote} onAddPost={this.addPost} onDownVote={this.addDownvote} sortByVotes={this.sortByVotes} sortByComments={this.sortByComments}{...params}/>} />
