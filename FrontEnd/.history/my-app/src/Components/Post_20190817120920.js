...
class Post extends React.Component {
  ...
  handleSubmit=(event)=>{
    ...
    let config = {
      headers: {
        "Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFicmFoYW1famVmZnlAeWFob28uY29tIiwidXNlcklkIjoiNWQ1NmM2YTliY2RlMDgzZDEwZWRkMDZmIiwiaWF0IjoxNTY2MDY4NzU2LCJleHAiOjE1NjYwNjkwNTZ9.gw1Hht0eNpQk4_DFhpiZlUaJA20vrzJ7oakJS8O6RZQ"
      }
    }
