...
class History extends React.Component {
    componentWillMount()
    {
      axios.get("http://localhost:3001/User/single/"+this.props.match.params.id).then(res=>this.setState({userdata:res.data.Post}))
  ...
  render(){
    console.log(this.state.userdata.data[0].username)
