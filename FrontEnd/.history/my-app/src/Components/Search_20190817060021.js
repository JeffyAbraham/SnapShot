...
this.setState({userinfo:[]})
  ...
  return (
    ...
    {this.state.userinfo.map((info,index)=> <li style={{marginLeft:"60px",border: "0.5px solid",marginTop: "-1px",listStyle:"none", backgroundColor:"ivory",padding: "12px",display: "block",borderColor:"none"}}><UserDesign info={info}/></li>)}
    </ul>
